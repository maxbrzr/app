...
class _LogFilesPageState extends State<LogFilesPage> {
  ...
  Future<void> _loadLogFiles() async {
    try {
      ...
      final files = await TimedExperimentLogger.getAllLogFiles();
  ...
  Future<void> _shareFile(File file) async {
    try {
      await SharePlus.instance.share(
        ShareParams(
          text: 'Timed Experiment Log Data',
  ...
  Future<void> _deleteFile(File file) async {
    final confirmed = await showPlatformDialog<bool>(
      ...
      builder: (context) => PlatformAlertDialog(
        ...
        content: Text('Are you sure you want to delete "${_getFileDisplayName(file)}"? This action cannot be undone.'),
        actions: [
    ...
    if (confirmed == true) {
      try {
        await TimedExperimentLogger.deleteLogFile(file);
